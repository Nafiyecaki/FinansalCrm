...
namespace FinansalCrm
{
    public partial class FrmBanks : Form
    {
        ...
        private void FrmBanks_Load(object sender, EventArgs e)
        {
            ...
            var isBankasiBalance = db.Banks.Where(x => x.BankTitle == "İşBankası")
               .Select(y => y.BankBalance).FirstOrDefault();

            lblisBankBalance.Text=isBankasiBalance.ToString() + " t";
            lblVakifBankBalance.Text=vakifBankBalance.ToString() + " t";
            lblZiraatBankBalance.Text=ziraatBankBalance.ToString() + " t";
            ...
            lblBankProcess3.Text = bankProcess3.Description + " " + bankProcess3.Amount + " " + bankProcess2.ProcessDate;
